...
var valid = false;
if (total) {
    if(total.value && total.value.contains('5.5')) {
        valid = true;
    }
}
return document.getElementById("contactInformation").style.display = "block";***/
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
            ...
            /*** window.location.assign("file:///C:/Users/wscho/OneDrive/Desktop/OneDrive%20-%20UMGC/CMST388/Projects/Project3/event_registration.html") ***/
        } else {
